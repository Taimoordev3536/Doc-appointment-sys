...
<div>
  <img className='w-32 ng-indigo-50' src={item.image} alt="" />
</div>
...
<div className='flex flex-col gap-2 justify-end'>
  ...
  <button className='text-sm text-stone-500 text-center sm:min-w-48 py-2 border rounded hover:bg-red-600 hover:text-white transition-all duration-300'>Cancel appointmet</button>
</div>
      </div>
    ))}
  </div>
